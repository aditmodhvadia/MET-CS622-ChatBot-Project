...
public interface NetworkWrapper {
     ...
     */
    <T> void makeGetRequest(Context context, String url, TypeToken typeToken, String tag,
     ...
     * @param networkCallback Network callback
     */
    <T> void makePostRequest(Context context, String url, TypeToken typeToken,
     ...
     * @param networkCallback Network callback
     */
    <T> void makePostRequest(Context context, String url, Object dataObject, TypeToken typeToken,
     ...
     * @param networkCallback Network callback
     */
    <T> void makePostStringRequest(Context context, String url, String data, TypeToken typeToken,
                                   String tag, NetworkCallback<T> networkCallback);
     ...
     */
    <T> NetCompoundRes<T> makePostRequestSync(Context context, String url, Object dataObject,
     ...
     * @param networkCallback Network callback
     */
    <T> void makePostRequestHeader(Context context, String url, Object dataObject, TypeToken typeToken,
                                   HashMap<String, String> hashMapHeader, String tag,
                                   NetworkCallback<T> networkCallback);
     ...
     * @param networkCallback Network callback
     */
    <T> void makeDeleteRequestHeader(Context context, String url/*, Object dataObject*/, TypeToken typeToken,
                                     HashMap<String, String> hashMapHeader, String tag,
                                     NetworkCallback<T> networkCallback);
     ...
     * @param networkCallback Network callback
     */
    <T> void makeGetRequestHeader(Context context, String url, TypeToken typeToken,
                                  HashMap<String, String> hashMapHeader, String tag,
                                  NetworkCallback<T> networkCallback);
     ...
     * @param <T>
     */
    <T> void makePutRequestHeader(Context context, String url, Object dataObject, TypeToken typeToken,
                                  HashMap<String, String> hashMapHeader, String tag,
                                  NetworkCallback<T> networkCallback);
    ...
    <T> void makeCustomPostForSocialRequest(Context context, String url,
                                            String dataObject, TypeToken<T> typeToken,
                                            HashMap<String, String> hashMapAuthenticate, String s,
                                            NetworkCallback<T> networkCallback);
}
